...
const playlistOrder = {
  ...
  MUSIKO: [274, 287, 319, 307, 281, 282, 239, 240, 251, 249, 170, 139, 272, 120, 112, 114, 321, 205, 204, 262, 186, 226, 233, 232, 227, 228, 229, 213, 206, 238, 288, 133, 140, 141, 145, 146, 130, 131, 126, 124, 125, 127, 187, 171, 172, 128, 129, 98, 99, 103, 123, 83, 84, 85, 86, 87, 88, 77, 79, 132, 215, 134, 133, 135, 136, 5, 6, 179, 216, 217],
...
function updateCoverSize() {
  ...
  if (IS_DESKTOP) {
    ...
    player.style.transform = 'translateX(3.5%)';
  } else {
